...
(function() {
  ...
  mxRectangleShape.prototype.isHtmlAllowed = function() {
    return (
      !this.outline &&
      (this.style == null ||
        (mxUtils.getValue(this.style, 'comic', '0') == '0' && mxUtils.getValue(this.style, 'sketch', urlParams['rough'] == '1' ? '1' : '0') == '0')) &&
      ...
      return function(state) {
        var handles = [
          createHandle(
            ...
            function(bounds) {
              var size =
                Math.max(0, Math.min(bounds.width, Math.min(bounds.height, parseFloat(mxUtils.getValue(this.state.style, 'size', defaultValue))))) * factor;
