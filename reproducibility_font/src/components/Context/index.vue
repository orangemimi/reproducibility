  ...
  <div class="main">
    <el-form ref="contextForm" :model="contextForm" label-width="110px" @submit.native.prevent size="mini">
      ...
      <el-form-item label="Temporal scale">
        <el-input v-model="contextForm.temporalScale" placeholder="Please enter the content."></el-input>
      </el-form-item>
      <el-form-item label="Spatio scale">
        <el-input v-model="contextForm.spatioScale" placeholder="Please enter the content."></el-input>
      </el-form-item>
...
<script>
import { getContextById, updateContexByProjectId, saveRecord } from '@/api/request';
...
export default {
  ...
  methods: {
    async getContext() {
      ...
      let data = await getContextById(this.projectId);
