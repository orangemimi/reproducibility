<template>
  <div class="card" ref="card" :style="styleVar">
    <el-row>
      <el-col class="row" :span="24"><div @click="clickHander('newFolder')"><span>新建文件夹</span></div></el-col>
      ...
      <el-col class="row" :span="24"><div @click="clickHander('new')"><span>新建</span></div></el-col>
...
<script>
// import { addUserFile } from '@/api/request'
export default {
  props: {
    position: {
      type: Object,
